...
public class Board1 extends JFrame implements ActionListener {
    ...
    protected Tiles[][] tiles = new Tiles[18][11];
    private JButton[][] buttons = new JButton[18][11];
    ...
    public Board1() {
        ...
        // Give the board empty spaces just to make the design of it
        for (int i = 0; i < 4; i++) {
            tiles[i][1] = null;
            tiles[i][3] = null;
            tiles[i][5] = null;
            ...
            for (int l = 0; l < 11; l++) {
                if (tiles[k][l] != null) {
                    if (tiles[k][l].getName().equals("Characters") && tiles[k][l].getId() == 1) {
                        ...
                        i += 63;
                        if (l % 2 == 0) {
                            buttons[k][l].setBounds(i, j + 25, icon.getIconWidth(), icon.getIconHeight());
                        } else {
    ...
    // Reshuffle help (currently not working)
    ...
    // Show free tiles help
    public void Free() {
        buttons[0][0].setBorder(BorderFactory.createLineBorder(Color.RED, 1));
        buttons[0][4].setBorder(BorderFactory.createLineBorder(Color.RED, 1));
        buttons[0][8].setBorder(BorderFactory.createLineBorder(Color.RED, 1));
        for (int i = 1; i < 17; i++) {
            ...
            for (int j = 0; j < 11; j++) {
                ...
                } else if (j % 2 == 1 && ((tiles[i][j - 1] == null && tiles[i - 1][j - 1] == null) || (tiles[i][j + 1] == null && tiles[i - 1][j + 1] == null))) {
                    buttons[i][j].setBorder(BorderFactory.createLineBorder(Color.RED, 1));
                } else if (j % 2 == 0 && ((tiles[i][j - 1] == null && tiles[i + 1][j - 1] == null) || (tiles[i][j + 1] == null && tiles[i + 1][j + 1] == null))) {
                    buttons[i][j].setBorder(BorderFactory.createLineBorder(Color.RED, 1));
                }
            }
    ...
    public void Deltiles() {
        ...
        for (int i = 1; i < 18; i++) {
            for (int j = 1; j < 11; j++) {
                if (k == 0 && l == 0) {
                    if (j % 2 == 0 && tiles[i][j] != null && ((tiles[i][j - 1] == null && tiles[i + 1][j - 1] == null) || (tiles[i][j + 1] == null && tiles[i + 1][j + 1] == null)) && (!tiles[i][j].getName().equals("Flowers") && !tiles[i][j].getName().equals("Seasons"))) {
                        k = i;
                        l = j;

                    } else if (j % 2 == 1 && tiles[i][j] != null && ((tiles[i][j - 1] == null && tiles[i - 1][j - 1] == null) || (tiles[i][j + 1] == null && tiles[i - 1][j + 1] == null)) && (!tiles[i][j].getName().equals("Flowers") && !tiles[i][j].getName().equals("Seasons"))) {
                        k = i;
                        l = j;

                    }
                } else if ((k != 0 || l != 0)) {
                    if (j % 2 == 0 && tiles[i][j] != null && (tiles[i][j].getName() == tiles[k][l].getName()) && (tiles[i][j].getId() == tiles[k][l].getId()) && ((tiles[i][j - 1] == null && tiles[i + 1][j - 1] == null) || (tiles[i][j + 1] == null && tiles[i + 1][j + 1] == null)) && (!tiles[i][j].getName().equals("Flowers") && !tiles[i][j].getName().equals("Seasons"))) {
                        ...
                        Win(endcounter++);
                    } else if (j % 2 == 0 && tiles[i][j] != null && (tiles[i][j].getName() == tiles[k][l].getName()) && (tiles[i][j].getId() == tiles[k][l].getId()) && ((tiles[i][j - 1] == null && tiles[i - 1][j - 1] == null) || (tiles[i][j + 1] == null && tiles[i - 1][j + 1] == null)) && (!tiles[i][j].getName().equals("Flowers") && !tiles[i][j].getName().equals("Seasons"))) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == exit) {
            ...
            try {
                ...
                out.write("Name : " + name + " Score : " + vathmologia + " at Board 2");
                out.newLine();
            ...
            JOptionPane.showMessageDialog(null, "Welcome to Board 2    !!!!!!!!!!!! \n   Good Luck " + name);
            ...
            if (firstClick == 1) {
                ...
                if (i != ii || j != jj) {
                    if (j == 0 || j == 10) {
                        if ((jj == 0 || jj == 10) && (tiles[i][j].getName().equals("Flowers") && tiles[ii][jj].getName().equals("Flowers"))) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
                            ...
                            stack.push(ii);
                            stack.push(jj);
                            playlist.remove(tiles[i][j]);
                            playlist.remove(tiles[ii][jj]);
                            tiles[i][j] = null;
                            tiles[ii][jj] = null;
                            buttons[i][j].setVisible(false);
                        ...
                        } else if ((jj == 0 || jj == 10) && (tiles[i][j].getName().equals("Seasons") && tiles[ii][jj].getName().equals("Seasons"))) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
                        ...
                        } else if ((jj == 0 || jj == 10) && (tiles[i][j].getName() == tiles[ii][jj].getName()) && (tiles[i][j].getId() == tiles[ii][jj].getId())) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
                        ...
                        } else if (jj % 2 == 1 && (tiles[i][j].getName().equals("Seasons") && tiles[ii][jj].getName().equals("Seasons")) && ((tiles[ii][jj - 1] == null && tiles[ii - 1][jj - 1] == null) || (tiles[ii][jj + 1] == null && tiles[ii - 1][jj + 1] == null))) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
                            ...
                            vathmologia += 10;
                            Win(endcounter++);
                        } else if (jj % 2 == 0 && (tiles[i][j].getName().equals("Seasons") && tiles[ii][jj].getName().equals("Seasons")) && ((tiles[ii][jj - 1] == null && tiles[ii + 1][jj - 1] == null) || (tiles[ii][jj + 1] == null && tiles[ii + 1][jj + 1] == null))) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
                            ...
                            vathmologia += 10;
                            Win(endcounter++);
                        } else if (jj % 2 == 1 && (tiles[i][j].getName().equals("Flowers") && tiles[ii][jj].getName().equals("Flowers")) && ((tiles[ii][jj - 1] == null && tiles[ii - 1][jj - 1] == null) || (tiles[ii][jj + 1] == null && tiles[ii - 1][jj + 1] == null))) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
                            ...
                            vathmologia += 10;
                            Win(endcounter++);
                        } else if (jj % 2 == 0 && (tiles[i][j].getName().equals("Flowers") && tiles[ii][jj].getName().equals("Flowers")) && ((tiles[ii][jj - 1] == null && tiles[ii + 1][jj - 1] == null) || (tiles[ii][jj + 1] == null && tiles[ii + 1][jj + 1] == null))) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
                            ...
                            vathmologia += 10;
                            Win(endcounter++);
                        } else if (jj % 2 == 1 && (tiles[i][j].getName() == tiles[ii][jj].getName()) && (tiles[i][j].getId() == tiles[ii][jj].getId()) && ((tiles[ii][jj - 1] == null && tiles[ii - 1][jj - 1] == null) || (tiles[ii][jj + 1] == null && tiles[ii - 1][jj + 1] == null))) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
                            ...
                            vathmologia += 20;
                            Win(endcounter++);
                        } else if (jj % 2 == 0 && (tiles[i][j].getName() == tiles[ii][jj].getName()) && (tiles[i][j].getId() == tiles[ii][jj].getId()) && ((tiles[ii][jj - 1] == null && tiles[ii + 1][jj - 1] == null) || (tiles[ii][jj + 1] == null && tiles[ii + 1][jj + 1] == null))) {
                            //remove
                            stack.push(tiles[i][j]);
                            stack.push(i);
                            stack.push(j);
